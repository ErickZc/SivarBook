...
<body class="body-image body-html">
    ...
    <div class="container">
                    ...
                    <div class="sidebar">
                        ...
                        <a class="menu-item" href="/emprendedor/getAll">
                            <svg width="20" height="20" fill="#000000" viewBox="0 0 24 24"
                                ...
                                <path
                                    d="M11 5.89 4.06 4.11A1.27 1.27 0 0 0 3 4.34a1.25 1.25 0 0 0-.48 1V17a1.25 1.25 0 0 0 .94 1.21L11 20.16V5.89Z">
                                </path>
                            ...
                            <div id="foto-contenedor">
                                <div class="profile-photo-primary-profile-2">
                                    <img src="data:image;base64,{{ $usuarios->imagen }}" id="foto"
                                        alt="Foto de perfil" class='imagen-turista' width='196' height='196'>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-md-8 offset-md-2">
                                <form id="Form1">
                                    ...
                                    <div class="form-floating mb-3">
                                        <input type="text" class="form-control text-left" placeholder="Nombre"
                                            disabled id="Nombre" value="{{ $usuarios->nombre }}">
                                    ...
                                    <div class="row">
                                        <div class="col-6">
                                            <button class="btn btn-outline-dark buttonGeneric" style="width: 100%;"
                                                id="editarPerfil" name="editarPerfil" type="button">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                    ...
                    <div class="data">
                        <div class="row">
                            <div class="col-auto">
                                ...
                                <p>En esta sección encontrarás las noticias más relevantes del mundo del turismo en el
                                    país.</p>
                            </div>
                        </div>
        ...
        <script>
            ...
            function callAPI() {
                const url =
                    'https://newsdata.io/api/1/news?apikey=pub_24023d24caea9400184d5f62d4dbd77f52c41&q=el%20salvador&country=sv&language=es&category=entertainment,food,health,tourism,technology';
